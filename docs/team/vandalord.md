---
layout: page
title: vandalord's Project Portfolio Page
---
...
**Code contributed**: [RepoSense link](https://nus-cs2103-ay2526-s2.github.io/tp-dashboard/?search=vandalord&breakdown=true)

**Enhancements to existing features**:
  * Updated the GUI color scheme (Pull request [\#89](https://github.com/AY2526S2-CS2103T-F10-1/tp/pull/89))
  * Added a split panel view for a focused view of the patients' details. (Pull request [\#89](https://github.com/AY2526S2-CS2103T-F10-1/tp/pull/89))
  * Reformat menubar items for better user experience. (Pull request [\#158](https://github.com/AY2526S2-CS2103T-F10-1/tp/pull/158))

**Documentation**:
  * User Guide:
    * Added documentation for the Appointment features [\#119]((Pull request [\#89](https://github.com/AY2526S2-CS2103T-F10-1/tp/pull/119))
  * Developer Guide:
